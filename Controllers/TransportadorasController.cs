...
namespace Projeto_Otilio.Controllers
{
    public class TransportadorasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Transportadora transportadora)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] Transportadora transportadora)
        {
