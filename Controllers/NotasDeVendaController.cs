...
namespace Projeto_Otilio.Controllers
{
    public class NotasDeVendaController : Controller
    {
        ...
        {
            var myDbContext = _context.NotasDeVendas.Include(n => n.Client).Include(n => n.Seller).Include(n => n.Transportadora);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["SellerId"] = new SelectList(_context.Vendedores, "Id", "Id");
        ...
        public async Task<IActionResult> Create([Bind("Id,Date,Type,ClienteId,SellerId,TransportadoraId,TipoDePagamentoId")] NotaDeVenda notaDeVenda)
        {
            ...
            ViewData["SellerId"] = new SelectList(_context.Vendedores, "Id", "Id", notaDeVenda.SellerId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Date,Type,ClienteId,SellerId,TransportadoraId,TipoDePagamentoId")] NotaDeVenda notaDeVenda)
        {
