...
namespace Projeto_Otilio.Controllers
{
    public class PagamentosComCartaoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Number,Brand,Id,NomeDoCobrado,InformacoesAdicionais")] PagamentoComCartao pagamentoComCartao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Number,Brand,Id,NomeDoCobrado,InformacoesAdicionais")] PagamentoComCartao pagamentoComCartao)
        {
