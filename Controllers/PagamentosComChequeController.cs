...
namespace Projeto_Otilio.Controllers
{
    public class PagamentosComChequeController : Controller
    {
        ...
        {
            return View(await _context.PagamentosComBoleto.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var pagamentoComCheque = await _context.PagamentosComBoleto
        ...
        public async Task<IActionResult> Create([Bind("Bank,BankName,Id,NomeDoCobrado,InformacoesAdicionais")] PagamentoComCheque pagamentoComCheque)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var pagamentoComCheque = await _context.PagamentosComBoleto.FindAsync(id);
            if (pagamentoComCheque == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Bank,BankName,Id,NomeDoCobrado,InformacoesAdicionais")] PagamentoComCheque pagamentoComCheque)
        {
        ...
        {
            var pagamentoComCheque = await _context.PagamentosComBoleto.FindAsync(id);
            _context.PagamentosComBoleto.Remove(pagamentoComCheque);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.PagamentosComBoleto.Any(e => e.Id == id);
        }
    }
}
